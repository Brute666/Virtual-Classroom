...
class Student(models.Model):
    ...
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    student_id = models.CharField(max_length=20, default='000000')
...
class Teacher(models.Model):
    admin = models.OneToOneField(CustomUser, on_delete=models.CASCADE)
    gender = models.CharField(max_length=100)
    course_taken = models.TextField(null=True)
    teacher_id = models.CharField(max_length=20, default='000000')
    mobile_number = models.CharField(max_length=11, null=True)
